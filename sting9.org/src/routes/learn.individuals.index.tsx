...
export const Route = createFileRoute('/learn/individuals/')({
  loader: () => {
    const metadata = loadCourseMetadata('individuals')
    return { metadata }
  },
  component: IndividualsCourseHub,
})

function IndividualsCourseHub() {
        ...
        <div className="space-y-4">
          ...
          {chapters.map((chapter) => (
            <Link
              ...
              className="block bg-white rounded-xl shadow hover:shadow-lg transition-all duration-200 p-6 group border-2 border-transparent hover:border-blue-500"
            >
              <div className="flex items-start gap-4">
                {/* Chapter Number */}
                <div className="flex-shrink-0 w-12 h-12 bg-blue-100 group-hover:bg-blue-200 rounded-lg flex items-center justify-center">
